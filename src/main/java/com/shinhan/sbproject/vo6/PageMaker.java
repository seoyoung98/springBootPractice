package com.shinhan.sbproject.vo6;
...
public class PageMaker<T> {
	...
	public PageMaker(Page<T> result, int cnt, int pageSize) {
		this.result = result;
	...
	public void calcPage(int cnt, int pageSize) {//pagelist의 갯수를 default로 20개로 잡음
		int tempEndNum = (int)(Math.ceil(currentPageNum/(pageSize*1.0))*pageSize); //20개중 마지막숫자 
